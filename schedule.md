...
| Week | Dates | Focus | Exact deliverables | Status |
| --- | --- | --- | --- | --- |
| 1-2 | May 11-May 24 | Foundation completed | Experimental skin entry, QML shell, `QmlLegacyLibraryItem`, safe legacy library/sidebar/table hosting. | Done |
| 3 | May 25-May 31 | Audit and architecture | Codebase audit, reuse/fork decisions, `res/qml/themes/LateNight` skeleton, LateNight buttons/toggles, library PR review until merge. | Done |
...
| 6 | June 15-June 21 | Deck parity and benchmarks | Hotcues 1-8, intro/outro cues, loop/beatjump actions, beatgrid/timing controls, overview markers, deck parity checklist, first CPU benchmark. | In-progress |
| 7 | June 22-June 28 | Mixer and toolbar | LateNight mixer, EQ/filter/PFL/meters/crossfader/main/headphone controls, standalone `Toolbar.qml`, status indicators, toolbar layout toggles replacing skin settings. | |
...
| Buffer | July 13-July 27 | Early-start compensation | No planned deliverables; async review only if needed. | |
...
| Submission | August 31-Sept 07 | Contributor submission week | Final polish, mentor feedback, final work product, final evaluation, PR-ready summary and video. | |
